...
Project.create!(
  ...
  description: "We started with a stock 1999 Jeep Grand Cherokee and went big from there. Up front, we managed to make 18-inch coilovers “fit” alongside a high-pinion Dana 44. In the rear, a 4-linked Ford 9-inch axle with a custom-built truss and Fox air shocks also “fit” pretty nicely. Some other highlights include chromoly axle shafts all around, 42-inch tires with beadlocks, and a custom-length reinforced rear driveshaft. Check out the 'break'-in run in our Videos section!",
  image: "project3.png",
  url: "",
  featured: true
)
